...
$route['Product_list/(:any)']='Front/product_list/$1';
$route['Product_list/(:any)/(:any)']='Front/product_list/$1/$2';
$route['Product_list/(:any)/(:any)/(:any)']='Front/product_list/$1/$2/$3';
...
$route['Insert_Vendor/(:any)/(:any)/(:any)/(:any)']='Vendor/Insert_Vendor/$1/$2/$3/$4';
...
$route['Delete_vendor/(:any)/(:any)/(:any)/(:any)']='Vendor/Delete/$1/$2/$3/$4';
$route['Update_all/(:any)/(:any)/(:any)/(:any)/(:any)']='Admin/Update_all/$1/$2/$3/$4/$5';
$route['Update_all_Vendor/(:any)/(:any)/(:any)/(:any)/(:any)']='Vendor/Update_all/$1/$2/$3/$4/$5';
$route['Update_Image/(:any)/(:any)/(:any)/(:any)/(:any)']='Vendor/Update_Image/$1/$2/$3/$4/$5';
...
$route['Edit_product_admin/(:any)/(:any)/(:any)/(:any)/(:any)']='Admin/Edit_product_admin/$1/$2/$3/$4/$5';
$route['Edit_product_vendor/(:any)/(:any)/(:any)/(:any)/(:any)']='Vendor/Edit_product_vendor/$1/$2/$3/$4/$5';
$route['Update_quantity/(:any)/(:any)/(:any)/(:any)/(:any)']='Admin/Update_quantity/$1/$2/$3/$4/$5';
$route['Edit_Setting/(:any)/(:any)/(:any)']='Admin/Edit_Setting/$1/$2/$3';
$route['API_Setting/(:any)/(:any)/(:any)']='Admin/API_Setting/$1/$2/$3';
$route['Smtp_Setting/(:any)/(:any)/(:any)']='Admin/Smtp_Setting/$1/$2/$3';
$route['Edit_setting_vendor/(:any)/(:any)/(:any)']='Admin/Edit_setting_vendor/$1/$2/$3';
$route['Insert_plan/(:any)/(:any)/(:any)/(:any)']='Admin/Insert_plan/$1/$2/$3/$4';
