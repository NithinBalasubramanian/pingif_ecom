...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Dashboard / Edit Category</h1>
...
<div class="col-xl-12 col-lg-7" style="padding:0px;">
  <div class="card shadow mb-4">
    ...
    <!-- Card Body -->
    <div class="card-body">
    <form class="form-horizontal" action="<?php echo base_url();?>Update_all/category/category/<?php echo $edit_id; ?>/list_category/list_category " method="post" enctype="multipart/form-data" >
    <?php $profile=$this->Admin_model->table_column('category','id',$edit_id);
    if(count($profile) > 0)
    {
        ...
        <div class="form-group col-md-6">
            ...
            <div class="col-sm-12">
            <input type="text" name= "category" id="" class="form-control mobile_full" id="inputEmail3" value="<?php echo $row['category']; ?>">
