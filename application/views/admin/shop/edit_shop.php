...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Dashboard / Edit Shop</h1>
...
<div class="col-xl-12 col-lg-7" style="padding:0px;">
  <div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      <h6 class="m-0 font-weight-bold text-primary">Edit Shop Form</h6>
    </div>
    <!-- Card Body -->
    <div class="card-body">
    <form class="form-horizontal" action="<?php echo base_url();?>Update_all/shop/shop/<?php echo $edit_id; ?>/edit_shop/list_shop " method="post" enctype="multipart/form-data" >
        <?php $shop=$this->Admin_model->table_column('shop','id',$edit_id);
        if(count($shop) > 0)
        {
            foreach($shop as $row)
            { ?>
