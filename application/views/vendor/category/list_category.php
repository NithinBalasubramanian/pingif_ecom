...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  ...
  <a href="<?php echo base_url();?>View_vendor/category/add_category" class=" d-sm-inline-block btn btn-sm btn-grad btn-primary shadow-sm"><i class="fas fa-add"></i> Add Category</a>
...
<div class="col-xl-12 col-lg-7" style="padding:0px;">
  <div class="card shadow mb-4">
    ...
    <table id="dataTable" class="table table-bordered table-striped">
            ...
            $product=$this->Admin_model->table_column($tablename='shop_category','customer_id',$customer_id);
            if(count($product)>0){
              $i=1;
              foreach($product as $p_row){
                ...
                <tr>
                  ...
                  <td><a href="javascript:void(0)" class="per_delete btn btn-sm btn-danger" data-id="<?php echo $p_row['id']; ?>" data-table="shop_category">Delete</a></td>
                </tr>
              <?php $i++; } ?>
            <?php } ?>
                </tbody>
