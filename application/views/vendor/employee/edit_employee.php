...
<div class="col-xl-12 col-lg-7" style="padding:0px;">
  <div class="card shadow mb-4">
    ...
    <!-- Card Body -->
    <div class="card-body">
    <form class="form-horizontal" action="<?php echo base_url();?>Update_all/shop_emp/employee/<?php echo $edit_id; ?>/edit_employee/list_employee " method="post" enctype="multipart/form-data" >
    <?php $cus=$this->Admin_model->table_column('shop_emp','id',$edit_id);
    if(count($cus) > 0)
    {
        foreach($cus as $row)
        { ?>
