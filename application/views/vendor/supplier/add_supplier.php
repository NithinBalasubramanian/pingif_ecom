...
<div class="col-xl-12 col-lg-7" style="padding:0px;">
  <div class="card shadow mb-4">
    ...
    <!-- Card Body -->
    <div class="card-body">
    <form class="form-horizontal" action="<?php echo base_url();?>Insert_Vendor/supplier/supplier/add_supplier/list_supplier " method="post" enctype="multipart/form-data" >
        <div class="box-body">
        <div class="row">
        <div class="form-group col-md-6">
            <label for="inputEmail3" class="col-sm-6 control-label">Supplier Name  </label>
            <div class="col-sm-12">
            <input type="text" name= "name" id="" class="form-control mobile_full" id="inputEmail3" placeholder="Supplier Name" required>
