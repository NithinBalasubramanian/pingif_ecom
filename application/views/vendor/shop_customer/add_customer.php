...
<div class="col-xl-12 col-lg-7" style="padding:0px;">
  <div class="card shadow mb-4">
    ...
    <!-- Card Body -->
    <div class="card-body">
    <form class="form-horizontal" action="<?php echo base_url();?>Insert_Vendor/shop_cus/shop_customer/add_customer/list_customer " method="post" enctype="multipart/form-data" >
        <div class="box-body">
        <div class="row">
