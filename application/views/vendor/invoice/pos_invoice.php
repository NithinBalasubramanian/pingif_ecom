...
<div class="app-main__inner" style="width:100%;">
            ...
            <div class="col-md-6" style="font-size: 12px;">Invoice No : <?php echo $sales_bill_row['invoice_no']; ?></div>
            <?php 
            ...
            <div class="col-md-6" style="font-size: 12px;">Customer Name : <?php echo strtoupper($cus_name); ?></div>
        </div>
        <div class="row" style="padding:10px;">
        <div class="col-md-6" style="font-size: 12px;">Date :<?php echo $date; ?></div>
            <div class="col-md-6" style="font-size: 12px;">Customer Number : <?php echo $cus_phone; ?></div>
        </div>
      <?php   } ?>
