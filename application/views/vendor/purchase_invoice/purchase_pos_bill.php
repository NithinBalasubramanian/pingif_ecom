...
<div class="app-main__inner" style="width:100%;">
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <div class="img row" style="width:100%;height:auto;margin-left:0px;">
                                ...
                                ?>
                                <h4 style="font-size: 15px;"><b><?php echo strtoupper($shop_name); ?></b></h4>
                                    <p style="font-weight:400;font-size:12px;"><?php echo strtoupper($address); ?><br>Contact: <?php echo $contact; ?></p>
                                </div>
                        ...
                        <?php $sales_bill =$this->Admin_model->table_column($tablename='shop_suplier_invoice',$column='invoice_no',$val=$invoice);
                        if(count($sales_bill)>0){
                            foreach($sales_bill as $sales_bill_row){
                                ...
                                $delivary = $sales_bill_row['delivery_type'];
                                 $sup_id = $sales_bill_row['sup_id'];
            ...
            <div class="col-md-6" style="font-size: 12px;">Ivoice No : <?php echo $sales_bill_row['invoice_no']; ?></div>
            <?php 
            $cus=$this->Admin_model->table_column('supplier','id',$sup_id);
            foreach($cus as $cus_row){ 
                $cus_name=$cus_row['name'];
               
                $cus_phone=$cus_row['contact']; ?>
           
            <div class="col-md-6" style="font-size: 12px;">Supplier Name : <?php echo strtoupper($cus_name); ?></div>
        </div>
        <div class="row" style="padding:10px;">
        <div class="col-md-6" style="font-size: 12px;">Date :<?php echo $date; ?></div>
            <div class="col-md-6" style="font-size: 12px;">Supplier Number : <?php echo $cus_phone; ?></div>
        </div>
      <?php   } ?>
   ...
   <div class="bill_table table-responsive">
    ...
    <tbody>
        ...
        <?php
        $i=1;
        $saled_list=$this->Admin_model->table_column('shop_suplier_data','invoice_no',$invoice);
