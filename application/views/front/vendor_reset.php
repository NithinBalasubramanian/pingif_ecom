...
<div class="row log">
    ...
    <div class="col-md-6 order-1">
        ...
        <div class="login">
            <div class="sign">
                <h2 class="s">  Reset your account</h2>
            </div>
            <div class="box">
            <div class="card loginbox">
                ...
                <?php } ?>
                    <form method="post" action="<?php echo base_url(); ?>vendor/vendor_reset/front/vendor_reset">
                        <div class="row">
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-transparent sig signin" style="  background-color:#2AC37D;">Send Link</button>
                        </div>
                    </form>
                </div>
            </div>
