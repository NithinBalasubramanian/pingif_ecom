  ...
  <script src="<?php echo base_url();?>assets/front/vendor/waypoints/jquery.waypoints.min.js"></script>
  <script src="<?php echo base_url();?>assets/front/vendor/counterup/counterup.min.js"></script>
